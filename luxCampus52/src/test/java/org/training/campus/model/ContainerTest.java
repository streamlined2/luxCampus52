...
class ContainerTest {
	...
	void testAddFail() {
		...
		assertThrows(IllegalStateException.class, () -> {
			c.add(e1);
		}, "the element already has been added to container");
	}
	...
	void testRemoveFail() {
		...
		assertThrows(NoSuchElementException.class, () -> {
			c.remove(employeeToRemove);
		}, "can't find employee to remove");
	...
	void testIteratorFail() {
		...
		assertThrows(NoSuchElementException.class, () -> {
			i.next();
		}, "empty coniner doesn't yield any element");
	}
